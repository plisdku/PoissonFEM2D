function [F, dFdp] = return_FEM_function_452(fem, p, Lx, Ly)
...
%     plot(contours(2).xFunc(p),contours(2).yFunc(p),'x')
    ...
    [particles, hit_objective] = SetupParticles_chrom3();
...
%     end
    ...
    PoissonFEM2D.FullResultsPlot(78945, femProblem, VV, geometry, idxN,...
