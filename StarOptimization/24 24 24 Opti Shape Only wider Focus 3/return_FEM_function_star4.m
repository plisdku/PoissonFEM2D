function [F, dFdp] = return_FEM_function_star4(fem, p, Lx, Ly)
...
%     plot(contours(2).xFunc(p),contours(2).yFunc(p),'x')
    ...
    [particles, hit_objective] = SetupParticles_star4();
    ...
    PoissonFEM2D.FullResultsPlot(7894, femProblem, VV, geometry, idxN,...
