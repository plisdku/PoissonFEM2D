...
geom2d.addContour(@(p) [-Lx_outer -L2/2-D12-L1 0 L2/2+D23+L3 Lx_outer Lx_outer 0 -Lx_outer], @(p) [0, 0, 0, 0, 0, Ly, Ly, Ly], s*[25, ratio, ratio, ratio, 25, 35, 35, 35], 1, 1:8);
...
[x, fval, iter, xHist, fHist, DfHist] = extremize_lars(fn_handle(fem), x0, 'Bounds', [minX, maxX], 'Callback', plot_func, 'MaxIter',10);
toc(t1)
save('StarOpti242424ShapeOnly_biggerbox' , 'x' , 'fval', 'iter', 'xHist', 'fHist', 'DfHist')
% 
