...
plot_func = @(xHistory,fHistory,DfHistory,max_x) plotfunc_star_voltage(xHistory, fHistory, DfHistory, max_x, end_p3, [5 5 5], 1);

[x, fval, iter, xHist, fHist, DfHist] = extremize_lars(fn_handle(fem), x0, 'Bounds', [minX, maxX], 'Callback', plot_func, 'MaxIter', 25);
toc(t1)
save('StarOpti242424FullNewExtremize' , 'x' , 'fval', 'iter', 'xHist', 'fHist', 'DfHist')
% 
