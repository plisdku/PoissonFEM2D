function [particles, hit_objective] = SetupParticles_Array()
   ...
   particles = ParticleArray(xv0(4:6,:),'Velocity',n_masses*ones(1,Nr),n_charges*ones(1,Nr),xv0(1:3,:),0*ones(1,Nr),end_time*ones(1,Nr),Nt*ones(1,Nr), Nr);
    ...
    hit_objective = @(x_v) hitObjective3D_pP_wrap(...
