function [particles, hit_objective, particles2, hit_objective2] = SetupParticles_test()
    ...
    particles2 = ParticleArray(xv0(4:6,:),'Velocity',n_masses*ones(1,Nr),n_charges*ones(1,Nr),xv0(1:3,:),0*ones(1,Nr),end_time*ones(1,Nr),Nt*ones(1,Nr), Nr);
    ...
    hit_objective2 =  @(x_v) hitObjective3D_pP_wrap(...
        x_v, x_p, y_p, z_p, vx_p, vy_p, vz_p, obj_weights, Nr);
end