function [particles, hit_objective] = SetupParticles_chrom3()
    ...
    Ne = 10;
    E_vec = linspace(E_center*0.98,E_center*1.02,Ne);

    v_center_vec = sqrt(2*E_vec / ion_mass);%linspace(v_center*0.98,v_center*1.02,Ne);

    Nr = 10;

    y_vec = linspace(-0.1e-3,0.1e-3,Nr);
