classdef JacobiEvaluator
    ...
    methods
        ...
        function obj = JacobiEvaluator(inN)
            ...
            for ii = 0:inN-1
                for jj = 0:inN-1
                    obj.coefficientArray(:,:,ii+1,jj+1) = support.jacobiPolynomialsNormalized(inN,ii,jj);
                end
            end
            ...
            for ii = 0:inN-1
                for jj = 0:inN-1
                    for kk = 1:inN
                        obj.derivCoefficientArray(kk,:,ii+1,jj+1) = support.diffPoly(obj.coefficientArray(kk,:,ii+1,jj+1));
                    end
                end
            end
        end
