function plotfunc_star_voltage_alpha(xHistory, fHistory, DfHistory, max_x,alpha, max_p, N_vec, N_voltage)
...
%     ylabel('change in geom. parameters')
    ...
    save('currentIteration', 'xHistory', 'fHistory', 'alpha', 'DfHistory')
