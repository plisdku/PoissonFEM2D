classdef FEMInterface < handle
    ...
    methods
        ...
        function obj = FEMInterface(parameterizedGeom, N_field, N_geom, N_quad, isAxisymmetric)
            obj.instantiatedGeom = PoissonFEM2D.InstantiatedGeometry2D(parameterizedGeom, N_field, N_geom, N_quad, isAxisymmetric);
        ...
        function [femp, dDirichlet_dp, dnx_dp, dny_dp] = assembleProblemWithMesh(obj, p)
            ...
            poi = PoissonFEM2D.PoissonFEM2D(obj.instantiatedGeom.tnMesh);
            
            femp = PoissonFEM2D.FEMProblem(poi);
