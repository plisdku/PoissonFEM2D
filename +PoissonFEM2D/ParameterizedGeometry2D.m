classdef ParameterizedGeometry2D < handle
    ...
    methods (Static)
        function bc = dirichlet(value, lineIds)
            bc = PoissonFEM2D.ParameterizedGeometry2D.boundaryCondition('dirichlet', value, lineIds);
        end
        
        function bc = neumann(value, lineIds)
            bc = PoissonFEM2D.ParameterizedGeometry2D.boundaryCondition('neumann', value, lineIds);
        end
    ...
    methods
        ...
        function instance = instantiate(obj, p)
            ...
            instance = PoissonFEM2D.InstantiatedGeometry2D(geometry, dvx_dp, dvy_dp);
        end
