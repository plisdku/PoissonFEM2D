...
% TriNodalMesh Geometry and topology of a triangulated FEM mesh with nodes
    ...
    methods
        ...
        function obj = TriNodalMesh(faces, xyNodes, N_field, N_geom, N_quad, inIsAxisymmetric)
            ...
            obj.hMesh = PoissonFEM2D.MeshTopology(faces);
            obj.hFieldNodes = PoissonFEM2D.NodalTopology(obj.hMesh, N_field);
            obj.hGeomNodes = PoissonFEM2D.NodalTopology(obj.hMesh, N_geom);
            obj.hQuadNodes = PoissonFEM2D.NodalTopology(obj.hMesh, N_quad);
            obj.hMeshNodes = PoissonFEM2D.NodalTopology(obj.hMesh, 2);
        ...
        function tnMesh = perturbed(obj, nodeIdx, directionIdx, delta)
            ...
            tnMesh = PoissonFEM2D.TriNodalMesh(obj.hMesh.faceVertices, xyNodes, ...
                obj.hFieldNodes.N, obj.hGeomNodes.N, obj.hQuadNodes.N, obj.isAxisymmetric);
