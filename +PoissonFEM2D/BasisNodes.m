classdef BasisNodes
    ...
    methods
        function obj = BasisNodes(N)
            obj.N = N;
            obj.basisEvaluator = PoissonFEM2D.BasisEvaluator2d(N);
            
            %obj.V = PoissonFEM2D.support2d.vandermonde(N);
            obj.V = obj.basisEvaluator.vandermonde();
            obj.invV = inv(obj.V);
            
            [obj.r, obj.s] = PoissonFEM2D.support2d.nodes2d(N);
            
            [obj.iVertices, iEdges, obj.iCenter] = PoissonFEM2D.support2d.classifyNodes(N);
        ...
        function [Dr, Ds] = gradientMatrix(obj, rr, ss)
            ...
            %[~, dVdr, dVds] = PoissonFEM2D.support2d.vandermonde(obj.N, rr, ss);
        ...
        function M = interpolationMatrix(obj, rr, ss)
            %V2 = PoissonFEM2D.support2d.vandermonde(obj.N, rr, ss);
