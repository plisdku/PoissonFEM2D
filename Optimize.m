...
geom2d.addContour(@(p) [-Lx, 0, Lx, Lx, 0, -Lx], @(p) [0, 0, 0, Ly, Ly, Ly], s*[0.5, 4, 0.5, 4, 4, 4], 1, 1:6);
geom2d.addContour(@(p) [-Lx+1e-3, -Lx+2e-3, -Lx+2e-3, -Lx+1e-3], @(p) [rAperture2, rAperture2, Ly-d, Ly-d], s*0.5, 2, 1:4);
geom2d.addContour(@(p) [-Lx+3e-3, -Lx+4e-3, -Lx+4e-3, -Lx+3e-3], @(p) [rAperture2, rAperture2, Ly-d, Ly-d], s*0.5, 3, 1:4);
geom2d.addContour(@(p) [Lx-2e-3, Lx-1e-3, Lx-1e-3, Lx-2e-3], @(p) [rAperture3, rAperture3, Ly-d, Ly-d], s*0.5, 4, 1:4);
geom2d.addContour(@(p) [Lx-5e-3, Lx-4e-3, Lx-4e-3, Lx-5e-3], @(p) [rAperture3, rAperture3, Ly-d, Ly-d], s*0.5, 5, 1:4);
...
fem.setDirichlet(2, @(p,x,y) 0.0 + p(1));
fem.setDirichlet(3, @(p,x,y) 1.0 + p(2));
fem.setDirichlet(4, @(p,x,y) 1.0 + p(3));
