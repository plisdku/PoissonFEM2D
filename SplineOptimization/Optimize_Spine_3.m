...
s = 1.25e-3;%4e-3; %1.3e-3; % mesh scale
ratio = 0.3;
...
Ncontour_vec = [6 6 6 6];%[100 100 100 100];%[30 30 30 30];
...
[x, fval, iter, xHist, fHist, DfHist] = extremize12(fn_handle(fem), x0, 'Bounds', [minX, maxX], 'Callback', @ plotfunc, 'MaxIter', 40);
toc(t1)
